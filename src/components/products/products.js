          ...
          {products.map((product) => {
            return (
              <div key={product.id} className="product-card">
                ...
                {/* First Image Only: Split text into two lines */}
                <h3 className="product-name">
                  {product.id === 1 ? (
                    <>
                      <span className="first-line">Chicken Drumstick</span>
                      <br />
                      <span className="second-line">Sampler Pack – 5 Pcs</span>
                    </>
                    ) : product.id === 6 ? ( // Last image: Without Skin split
                        <>
                          <span className="first-line">Whole Chicken Roaster</span>
                          <br />
                          <span className="second-line1">(Without Skin)</span>
                        </>
                  ) : (
                    product.name
                  )}
